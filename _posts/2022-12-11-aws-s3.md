...
- [S3 Glacier Instant Retrieval](https://aws.amazon.com/glacier/) - an object storage capability that is way, way cheaper than S3 Standard but you get charged for retrieval which is... instant. The minimum time in class is 90 days and 128kb minimum size.
